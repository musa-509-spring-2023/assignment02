...
--- if a stop has wheelchair boarding but it's not frequently serviced, it's a 0. Otherwise, it's a 1.
stops_score as (
    select
        stop_id,
        neighborhood_name,
...
order by accessibility_metric desc, num_bus_stops_accessible desc, neighborhood_name 
limit 5
