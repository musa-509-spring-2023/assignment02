...
-- get the blockgroups of each stop within 800 meters, limited to Philadelphia
...
-- get the population of each bus stop from the filtered list above
...
-- get lowest 8 stations with at least 500 people from list above, 
select
    stops.stop_name,
