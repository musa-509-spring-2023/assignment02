-- making an accessibility metric

-- so a fully accessble bus stop is one where
    -- stop is 1 wheelchair_boarding OR (0 AND parent is 1)
    -- AND trip (as in vehicle) at that stop is 1 (BUT THAT PART IS CONFUSING SO I'LL JUST DO FIRST FOR NOw)
